...
ExceptionMessage getExceptionMessageFromFirebaseException(FirebaseAuthException firebaseAuthException) {
  return ExceptionMessage(
    code: firebaseAuthException.code,
    message: _errorMap[firebaseAuthException.code] ?? 'Error desconhecido',
  );
}
